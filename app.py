...
if not api_key:
    ...
    if user_prompt := st.chat_input("Ask a research question or input a topic..."):
            ...
            with st.spinner("Analyzing research query..."):
                try:
                    response = client.models.generate_content(
                        ...
                        contents=f"You are an academic research assistant. Provide clear and structured research analysis for: {user_prompt}"
                    )
